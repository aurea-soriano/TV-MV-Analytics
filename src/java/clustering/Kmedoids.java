...
public class Kmedoids extends Clustering {
    ...
    public ArrayList<ArrayList<Integer>> execute(DistanceMatrix dmat) throws IOException {
       ...
       this.clusters = new ArrayList<>();
        ...
        //Vari�vel auxiliar para armazenar as med�ides antigas
        ...
        //indica se as med�ides foram modificadas
        ...
        while (medoidModified && nroIterations < dmat.getElementCount()) {
            ...
            for (int point = 0; point < dmat.getElementCount(); point++) {
                int nearestCluster = 0; //armazenar� a cluster que o ponto pertencer�
                float distance = dmat.getDistance(point, medoids[nearestCluster]);

                //verificar qual cluster o ponto est� mais pr�ximo (com base na med�ide)
            ...
            //Armazena os valores antigos das med�ides
            oldMedoids = medoids;

            //Atualiza as med�ides
    ...
    public int[] getMedoids() throws IOException {
        return this.medoids;
    }
