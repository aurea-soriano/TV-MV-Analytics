 ...
 * @author aurea
 */
public class HeatedObject implements ColorScale {
    ...
    public static void main(String[] args) {
        ...
        try {
            HeatedObject heatedObject = new HeatedObject();
            ImageIO.write(heatedObject.getBufferedImage(), "png", new File("/home/aurea/heatedObject.png"));
