...
<%
    ...
    if (haarLevelRangeStr != null) {
        ...
        System.out.println("haar request");
    } else {
        ...
        if (haarLevelRangeSession != null) {
            ...
            System.out.println("haar session");
        }
    }
    int maxHaarLevelRange = 0;
    System.out.println(haarLevelRange);
        ...
        if (colorStyleRadioButton != null) {
            ...
            if (colorStyleRadioButton.equals("category")) {
                ...
                if (filteredSource1Categories.size() > 1) {
                    ...
                    float[] silhouetteCoefficients = silhouetteCoefficient.execute(abstractMatrixCategory, abstractDissimilarity);
            ...
            if (optionClustering == null) {
                ...
                if (optionClustering.equals("reclustering")) {
                    ...
                    if (clustering.equals("Xmeans")) {
                        ...
                        resultClustering = clusteringMethod.execute(abstractDissimilarity, abstractMatrix);
                    ...
                    if (resultClustering.size() > 1) {
                        SilhouetteCoefficient silhouetteCoefficient = new SilhouetteCoefficient();
                        float[] silhouetteCoefficients = silhouetteCoefficient.execute(abstractMatrix, abstractDissimilarity);
...
sizeCellWidth=sizeCellHeight;
        ...
        if (projectedMatrix != null) {
            ...
            maxHaarLevelRange = utils.Util.calculateMaxHaarLevel(listTimeIntervalsData.get(0).getMatrix().getCols());
        ...
        <tr>
            ...
            <td style="width:340px;">
                <table >
                    ...
                    <tr>
                        <td style="text-align: right;" ><b>Similarity:</b></td>
                        <td " >  
                            <select name="listSimilarity" id="listSimilarity"  style="width: 135px">
                ...
                <table style="text-align: center; margin:0 auto; margin:auto; ">
                    ...
                    <tr>
                        <td   colspan="2">
                            <table style="margin:0 auto; margin:auto;">
                                <tr>
                                    <td colspan="3"> <input type="text" id="haarLeveldInput" readonly value="<%=haarLevelRange%>" style="border:0;text-align: center;">
                                    </td>

                                </tr>
                                <tr><td>0</td>
                                    <td>
                                        <input type="range" id="haarLeveldSlider" name="haarLeveldSlider" value="<%=haarLevelRange%>" min="0" max="<%=maxHaarLevelRange%>"  style="width: 500px;"
                                                    ...
                                                    <table style='font-size:3px; border-style:solid; margin:0 auto; margin:auto;'  >
                                                        <tr>
                                                            ...
                                                            <% }
                                                                ...
                                                                TimeCircular timeCircular = new TimeCircular(listTimeIntervalsData.get(index), colorScaleCell, 0.8, haarLevelRange);
