        ...
        for (int i = 0; i < projectedMatrixNHP.getRowCount(); i++) {
            ...
            if (projectedMatrixNHP.getRow(i).getKlass()>=minValueFilter &&
                ...
                datasetProjection += "{\'x\':" + valueX + ", \'y\':" + valueY + ", \'color\': \'" + colorBackground
                        + "\', \'name\': \'" + listLabelsNHP.get(i) + "\', \'date\': \'" + listLabelsNHP.get(i) + "\'},";
...
<script type="text/javascript"> createInstanceProjection("instanceProjectionMapContentAjax", "1110", "760", "<%=datasetProjection%>");</script> 
</div>