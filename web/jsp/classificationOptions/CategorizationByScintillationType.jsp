...
%>
<select name="selectCategorizationByScintillationType" id="selectCategorizationByScintillationType"   style="width: 120px" onchange="clearMessage();loadDescriptionCategorizationByScintillationType();" >
...
%>
<select name="selectCategorizationByScintillationType" id="selectCategorizationByScintillationType"   style="width: 120px" >
    <option value="select">Select...</option>
</select>
<%}%>